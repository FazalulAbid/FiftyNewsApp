...
import com.fifty.fiftynews.adapters.NewsAdapter
import com.fifty.fiftynews.adapters.NewsCategoryAdapter
import com.fifty.fiftynews.databinding.FragmentBreakingNewsBinding
import com.fifty.fiftynews.ui.NewsActivity
import com.fifty.fiftynews.ui.ProfileAndSettingsActivity
import com.fifty.fiftynews.ui.viewmodels.NewsViewModel
import com.fifty.fiftynews.util.Constants
import com.fifty.fiftynews.util.Constants.Companion.QUERY_PAGE_SIZE
...
class BreakingNewsFragment : Fragment(R.layout.fragment_breaking_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsCategoryAdapter.setOnItemClickListener {
            ...
            viewModel.getBreakingNews(com.fifty.fiftynews.Session.user.countryCode, NewsViewModel.newsCategory, false)
        }
...
//        Call breaking news live data and to observe on that.
    ...
    private val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (shouldPaginate) {
                viewModel.getBreakingNews(com.fifty.fiftynews.Session.user.countryCode, NewsViewModel.newsCategory, true)
                isScrolling = false
            }
        }
    }
