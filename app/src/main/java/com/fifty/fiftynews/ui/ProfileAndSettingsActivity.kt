...
import com.fifty.fiftynews.adapters.CountriesSpinnerAdapter
import com.fifty.fiftynews.databinding.ActivityProfileAndSettingsBinding
...
import com.fifty.fiftynews.util.CommonFunctions
import com.fifty.fiftynews.util.Constants
import com.fifty.fiftynews.util.Constants.Companion.IS_DEBUG
import com.fifty.fiftynews.util.Constants.Companion.IS_USER_DEFAULT_VALUE
import com.fifty.fiftynews.util.Constants.Companion.USER_AUTH
...
class ProfileAndSettingsActivity : AppCompatActivity() {
    ...
    private fun initializeComponents() {
        ...
        spinnerAdapter = com.fifty.fiftynews.adapters.CountriesSpinnerAdapter(this, Constants.COUNTRIES)
        ...
        viewModel.getUserFromFireStore(auth.uid.toString()) {
            when (it) {
                ...
                is UiState.Success -> {
                    ...
                    val adapter = binding.spinnerCountries.adapter as com.fifty.fiftynews.adapters.CountriesSpinnerAdapter
