...
import com.fifty.fiftynews.NewsApplication
...
class NewsViewModel(
    ...
    init {
        getBreakingNews(com.fifty.fiftynews.Session.user.countryCode, newsCategory, false)
    }
    ...
    fun saveArticle(article: Article) = viewModelScope.launch {
        article.uid = com.fifty.fiftynews.Session.user.uid
    ...
    private fun hasInternetConnection(): Boolean {
        ...
        val connectivityManager = getApplication<com.fifty.fiftynews.NewsApplication>().getSystemService(
