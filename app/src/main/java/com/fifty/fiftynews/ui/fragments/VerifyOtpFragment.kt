...
import com.fifty.fiftynews.databinding.FragmentOtpBinding
...
class VerifyOtpFragment : Fragment(R.layout.fragment_otp) {
    ...
    private val btnResentOtpOnClickListener = OnClickListener {
        try {
            sendOtp()
            timer.cancel()
            timer.start()
            ...
            Toast.makeText(activity, "Couldn't resend OTP, please try again", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private val btnVerifyOtpOnClickListener = OnClickListener {
